...
loaded_model = load_model('best_model.h1') # bset모델 가져오기
...
mc = ModelCheckpoint('best_model.h2', monitor = 'val_acc', mode = 'max', verbose = 1, save_best_only = True)
model.compile(optimizer='adam', loss = 'binary_crossentropy', metrics = ['acc'])

history = model.fit(x_train, y_train, epochs = 20, validation_data = (x_test, y_test), callbacks=[es, mc])

loaded_model = load_model('best_model.h5')# bset모델 가져오기
